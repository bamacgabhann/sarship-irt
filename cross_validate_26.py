...
test_results = f'/home/breandan/sarship/tests_checkpoints.csv'
...
def validate_checkpoints(_architectures, _training_datasets, _testing_datasets, checkpoint_results=None, _device=[0,1]):
    ...
    for a in _architectures:
        for t in _training_datasets:
            ...
            checkpoint_results_drive = f'/run/user/1000/gvfs/google-drive:host=gmail.com,user=b.macgabhann/0APHu4FCy59LUUk9PVA/1sO75zhWdpRY01UXP9--lxHQMskteUt1K/{checkpoint_results}.csv'
